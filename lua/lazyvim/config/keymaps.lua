...
map({ "n", "x" }, "<Down>", "v:count == 0 ? 'gk' : 'k'", { desc = "Down", expr = true, silent = true })
map({ "n", "x" }, "l", "v:count == 0 ? 'gl' : 'l'", { desc = "Up", expr = true, silent = true })
map({ "n", "x" }, "<Up>", "v:count == 0 ? 'gl' : 'l'", { desc = "Up", expr = true, silent = true })

-- Move to window using the <ctrl> hjkl keys
map("n", "<C-j>", "<C-w>j", { desc = "Go to Left Window", remap = true })
map("n", "<C-k>", "<C-w>k", { desc = "Go to Lower Window", remap = true })
map("n", "<C-l>", "<C-w>l", { desc = "Go to Upper Window", remap = true })
map("n", "<C-;>", "<C-w>;", { desc = "Go to Right Window", remap = true })
